/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.stg.jsonc` (hash: be90fa66896a22d9e1ad948ceafdc5c9)
// Runtime types generated with workerd@1.20260409.1 2026-04-01 enable_request_signal,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		GOOGLE_SPREADSHEET_CLIENT_SECRET: string;
		GOOGLE_SPREADSHEET_ACCESS_TOKEN: string;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler */;
		WORKER_SELF_REFERENCE: Fetcher /* ryota-blog-stg */;
	}
}
