...
const CustomH3 = ({ children, id, ...RestProps }: CustomH3Props) => {
  ...
  return (
    <div className="inline-block relative group cursor-pointer my-3" onClick={handleCopy}>
      ...
      {/* NOTE: コピー後の表示 */}
      <p className={cltw("text-xs content-center px-2 py-0.5 rounded bg-base-color dark:bg-secondary translate-x-full duration-300 absolute right-0 top-[5px] text-txt-base", isClicked ? "inline-block" : "hidden")}>Copied !</p>
