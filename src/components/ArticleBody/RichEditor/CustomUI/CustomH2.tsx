  ...
  return (
    <div className="py-3 my-3 border-b-secondary border-b-2 group cursor-pointer" onClick={handleCopy}>
      <div className="inline-block relative">
        ...
        {/* NOTE: コピー後の表示 */}
        <p className={cltw("text-xs content-center px-2 py-1 rounded bg-base-color dark:bg-secondary translate-x-full duration-300 absolute right-0 top-[5px] text-white", isClicked ? "inline-block" : "hidden")}>Copied !</p>
