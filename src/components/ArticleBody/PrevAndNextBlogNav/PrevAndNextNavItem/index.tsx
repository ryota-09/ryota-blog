...
const PrevAndNextBlogNavItem = ({ role, data }: PrevAndNextBlogNavItemProps) => {
  ...
  return (
    <Link href={`/${locale}/blogs/${categoryId}/${data.slug}`} className={cltw("max-w-1/2 py-4 transition text-gray-500 dark:text-gray-400 underline underline-offset-4 hover:opacity-70 hover:text-base-color hover:no-underline", role === "prev" ? "text-left" : "text-right")}>
