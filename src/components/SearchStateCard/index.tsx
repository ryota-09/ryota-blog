  ...
  return (
    <div className="bg-white px-3.5 flex flex-grow flex-col lg:flex-row items-center gap-2 lg:gap-10 border-2 border-gray-200">
      <div className="flex items-center gap-2 w-full lg:w-auto">
        ...
        <p className="text-sm lg:text-lg text-gray-500">検索条件 </p>
      </div>
      <div className="flex flex-col lg:flex-row flex-grow justify-between items-center gap w-full lg:w-auto">
        <ul className="flex gap-4 items-center">
          {category && (
            <li>
              <Chip classes=" text-xs lg:text-md bg-base-color px-3 py-2 text-sm text-txt-base" label={category} />
            </li>
          )}
          {keyword && (
            <li>
              <Chip classes="text-xs lg:text-md bg-light px-3 py-2 text-sm text-txt-base" label={keyword} />
            </li>
          )}
        </ul>
