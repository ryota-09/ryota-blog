...
const ArticleCard = ({ data }: ArticleCardProps) => {
  return (
    <div className="bg-white relative dark:bg-black border-2 border-gray-200 dark:dark:border-gray-600 overflow-hidden p-6 h-full flex flex-col">
      ...
      <div className="flex gap-4 h-full flex-col-reverse md:flex-row">
        ...
        {data.thumbnail ? (
          ...
          :
          <div className="relative z-40 md:flex-shrink-0 md:w-[45%] lg:w-[28%] xl:w-[45%] mt-4 md:mt-2 max-h-[250px] md:max-h-auto overflow-hidden">
            <Link href={`/blogs/${data.id}`}>
