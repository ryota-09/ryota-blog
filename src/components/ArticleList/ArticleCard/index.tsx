...
const ArticleCard = ({ data }: ArticleCardProps) => {
  return (
    <div className="bg-white dark:bg-black border-2 border-gray-200 dark:dark:border-gray-600 p-6 h-[540px] sm:h-[620px] md:h-[290px] flex flex-col relative">
      ...
      <div className="flex gap-4 h-full flex-col-reverse md:flex-row">
        <div className="md:w-[70%] flex flex-col justify-between">
          <p className="mt-2 text-gray-500 h-[6rem] sm:h-auto line-clamp-4 sm:line-clamp-3 md:line-clamp-5">{data.description}</p>
        ...
        {data.thumbnail ? (
          ...
          :
          <div className="md:flex-shrink-0 md:w-[45%] lg:w-[28%] xl:w-[45%] mt-4 md:mt-2 max-h-[350px] md:max-h-auto min-h-[220px] md:min-h-[140px] h-full flex flex-col items-center overflow-hidden">
