  ...
  return (
    <div className="bg-white border-2 border-gray-200 overflow-hidden p-6 h-full flex flex-col">
      ...
      <div className="flex gap-4 h-full flex-col-reverse md:flex-row">
        ...
        {data.thumbnail ? (
          <div className="md:flex-shrink-0 md:w-[45%] lg:w-[28%] xl:w-[45%] mt-4 md:mt-2 max-h-[250px] md:max-h-auto overflow-hidden flex items-center">
          ...
          <div className="md:flex-shrink-0 md:w-[45%] lg:w-[28%] xl:w-[45%] mt-4 md:mt-2 max-h-[250px] md:max-h-auto overflow-hidden">
            <Link href={`/blogs/${data.id}`}>
              <p className="bg-gray-300 transition-opacity hover:opacity-80 h-[200px] md:h-[150px] w-auto flex items-center justify-center text-gray-400 text-3xl font-bold" >No Image</p>
            </Link>
          </div>
        }
      </div>
