...
const Page = () => {
  return (
    <article className="flex-grow flex flex-col md:flex-row items-center justify-center md:justify-between gap-8 w-full min-h-[600px] bg-white border-2 border-gray-200 h-full px-8">
