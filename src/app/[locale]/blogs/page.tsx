...
import { BLOG_TYPE_QUERY, CATEGORY_QUERY, KEYWORD_QUERY, PAGE_QUERY, CATEGORY_MAPED_ID } from "@/static/blogs";
...
export async function generateMetadata(
  ...
  if (blogType === "blogs" && !category && !keyword) {
    return {
      title: page ? `${t('recentPosts')} - ${t('page')} ${page}` : tMeta('siteTitle'),
  ...
  if (category) {
    ...
    const categoryId = CATEGORY_MAPED_ID[category as keyof typeof CATEGORY_MAPED_ID] || category;
    try {
