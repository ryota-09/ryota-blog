...
As I mentioned, I withdrew because I'd started dating someone I met on a matching app (Pairs) I was using in parallel. The relationship didn't come through Hitooshi itself, but the experience of clocking first-meeting reps with a planner cheering me on absolutely paid off later.

How I actually juggled the app alongside Hitooshi — including how the terms of service treat it — is spun off into [my article on combining Hitooshi with dating apps and marriage agencies](/en/blogs/zakki/hitooshi-heiyou).
...
If "but is it sketchy in the first place?" is still nagging at you, I dug through Yahoo! Chiebukuro, 2ch, and the review sites in [my investigation of the sketchy/scam/fake-member rumors](/en/blogs/zakki/hitooshi-yabai). And if it's the entrance screening you're worried about, [what the screening actually checks and the truth about the pass rate](/en/blogs/zakki/hitooshi-screening) covers that.

If you do join, the Summer Matchmaking Support Campaign is on right now, and the invitation code saves you 26,700 yen (cannot be combined with other campaigns; the discount amount is the same whichever campaign applies). Feel free to use mine☺️

If you're going to use it, mind the deadline: registration and the interview booking need to be done by Sunday, August 30, and the interview date itself can fall after that.
...
### Is "withdrawal" different from "cancellation"?

A. They're the same thing. The [terms of service](https://hito-oshi.com/rule/) speak of "terminating (cancelling) the membership agreement," and the money conditions — cancellation fees, refunds — are written in that language. The service itself, and every LINE message I got, calls it withdrawal; the form I submitted was literally the "withdrawal application form." Whichever word you searched for, it's the same procedure.
