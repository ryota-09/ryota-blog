...
\* All figures and service areas in this article are based on **information published as of June 2026**. Please check the [official Hitooshi website](https://hito-oshi.com/?ref=shoukai-app) for the latest. If you go on to apply from there, entering the referral code at the end of this article knocks 5,000 yen off the enrollment fee.
...
If you live outside these areas, member profile aside, using the service is difficult, so please check the [official site](https://hito-oshi.com/?ref=shoukai-app) for the latest.
