...
For what this screening actually looks at, see [my deep dive into the enrollment screening (reviewed items, acceptance-rate rumors, and tips to pass)](/en/blogs/zakki/hitooshi-screening).
...
### If You Decide to Enroll, the Invitation Code Saves You 26,700 Yen (Free Consultation Only Is Also Fine)

If, after hearing them out, you feel "this might suit me" and enroll, the Summer Matchmaking Support Campaign is on right now, and using the invitation code gets you **26,700 yen in savings** (as of August 2026). 26,700 yen is roughly **a month and a half of the monthly fee**, so there's no reason not to use it. If you'd like, feel free to use my referral code☺️

Just watch the deadline: as long as your registration and interview booking are in by Sunday, August 30, an interview date in September still counts — so if you're on the fence, grabbing a slot first is the smart play.
