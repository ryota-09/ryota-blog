...
description: What is Hitooshi's marriage-hunting service? A former user neutrally explains how it works, the cost, how it differs from matching apps and marriage agencies, the member age range, and who it suits.
...
| Service areas    | 17 prefectures across Kanto, Kansai, and Tokai ([full list and sign-up requirements](/en/blogs/zakki/hitooshi-eligibility)) |
...
For the details, see [my article on Hitooshi's screening criteria and tips to pass](/en/blogs/zakki/hitooshi-screening)!
...
Hitooshi's service areas cover 17 prefectures across the Kanto, Kansai, and Tokai regions (as of August 2026). For the full prefecture list and your options if you live outside the area, see [my guide to Hitooshi's service areas and sign-up requirements](/en/blogs/zakki/hitooshi-eligibility).
...
- [How I withdrew from Hitooshi and what it cost](/en/blogs/zakki/hitooshi-withdrawal): the steps, the cancellation fee, and pausing vs. leaving
...
### Joining? The Invitation Code Saves You 26,700 Yen

If you hear them out and feel "this might suit me" and enroll, the Summer Matchmaking Support Campaign is on right now, and using the invitation code gets you **26,700 yen in savings** (as of August 2026). There's no reason not to use it, so if you'd like, please feel free to use my referral code☺️

One small caveat: the campaign runs until Sunday, August 30. What has to be completed within the period is just the registration and the first-interview booking, so the interview itself can come later. Booking alone takes only a few minutes.

▼Apply here!!

[Hitooshi](https://hito-oshi.com/?ref=shoukai-app)

When you enroll, registering as a new member with the invitation code below gets you 26,700 yen in savings through the Summer Matchmaking Support Campaign! (Note: this cannot be combined with other campaigns — the discount amount is the same whichever campaign applies.)
...
Note that this campaign cannot be combined with other offers such as the discount for those 29 and under. The discount amount is the same either way. Check the official LINE for the latest campaign status!
