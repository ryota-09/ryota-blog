...
This is the most reliable one. The Summer Matchmaking Support Campaign is running right now: register as a new member with an existing member's invitation code and you save 26,700 yen in total (as of August 2026; cannot be combined with other campaigns).
...
When you apply, select "Introduced by an acquaintance" and enter the invitation code to save 26,700 yen through the campaign (cannot be combined with other campaigns).
