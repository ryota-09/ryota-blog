---
title: Is Hitooshi Expensive? Total Cost of the Enrollment & Monthly Fees, and How to Save 26,700 Yen
description: A real, numbers-based breakdown of the matchmaking service "Hitooshi." Covers the 17,800 yen enrollment fee + 17,800 yen monthly fee with zero success fee, a 3/6/12-month total-cost simulation, a comparison against matching apps and traditional marriage agencies, and how to save 26,700 yen with a referral code.
...
| -------------------- | ----------------------------------------------- |
| Enrollment fee       | 17,800 yen (26,700 yen in savings with the invitation-code campaign) |
...
> ⚠️ **The one thing to watch out for is the "3-month minimum usage period."** Leaving before it's up means a fee of up to 20,000 yen. More on that in the "fee breakdown" section below.
...
### Enrollment Fee: 17,800 Yen (Invitation-Code Campaign: 26,700 Yen in Savings)

The enrollment fee of 17,800 yen is charged just once when you sign up.

At a typical marriage agency, the enrollment fee + registration fee + initial activity costs often add up to **100,000–180,000 yen**, so this is quite modest. And as I'll cover later, the Summer Matchmaking Support Campaign is on right now: **using the invitation code saves you 26,700 yen in total**.
...
### Minimum Usage Period: 3 Months (Only a Concern If You Leave Early)
...
The thing to understand before signing up is that **leaving before those 3 months are up is the one case where a fee applies on top of your monthly payments.** It caps at 20,000 yen (tax incl.) and comes out lower when less of the term remains. So it's not suited to a "just try it for a month and quit right away if it doesn't fit" approach⚠️

The formula from the terms, a lookup table of what it costs by remaining term, and what the process actually looks like are all split out — LINE screenshots included — into [my walkthrough of withdrawing from Hitooshi and the cancellation fee](/en/blogs/zakki/hitooshi-withdrawal). This article stays focused on what it costs to get in.
...
And here's how it looks **with the invitation-code campaign (26,700 yen in savings) applied**:

| Usage period | Normal total | With campaign |
| ------------ | ------------ | ------------------ |
| 3 months     | 71,200 yen   | **44,500 yen**     |
| 6 months     | 124,600 yen  | **97,900 yen**    |
| 12 months    | 231,400 yen  | **204,700 yen**    |
...
### Use the Invitation Code to Save 26,700 Yen

This is the most reliable one. The Summer Matchmaking Support Campaign is running right now: register as a new member with an existing member's invitation code and you save 26,700 yen in total (as of August 2026; cannot be combined with other campaigns; the discount amount is the same whichever campaign applies).

26,700 yen works out to about a month and a half of the monthly fee, after all. If you'd like, please feel free to use my referral code☺️

One thing to note: the campaign closes on Sunday, August 30. That said, all that needs to happen within the period is registering your basic information and booking the first interview — the interview date itself can slip into September and you still qualify.
...
- The invitation-code campaign saves you 26,700 yen, so there's no reason not to use it
...
- The only constraint is the "3-month minimum usage period"; just note that leaving before it's up costs up to 20,000 yen
...
If you're interested, first check the latest pricing and campaigns via a free consultation, and don't forget to use the **26,700-yen invitation-code campaign**!

▼Apply here!!

[https://hito-oshi.com/?ref=shoukai-app](https://hito-oshi.com/?ref=shoukai-app)

When you apply, select "Introduced by an acquaintance" and enter the invitation code to save 26,700 yen through the campaign (cannot be combined with other campaigns; the discount amount is the same whichever campaign applies).
...
- [Terms of Service | Hitooshi](https://hito-oshi.com/rule/) (minimum usage period and last-minute cancellation fees)
