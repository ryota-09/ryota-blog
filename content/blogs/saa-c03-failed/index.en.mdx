...
(Update) I retried a month later just as I said I would, and passed with 780 points!
...
One last thing - let me plug something of my own.

This is pure hindsight, but I don't think what stopped me at 703 points was "a service I'd never heard of". **I couldn't put into words why I ruled out the option I didn't pick** in that final two-way choice. That's all it was.

Questions you get right on "this one feels about right" come back to bite you the moment the options are shuffled a little. As long as you read the explanation and stop at "ah, I see", that gap never closes.

<br />

So I've started an AWS certification study-support plan on MENTA, where I review your reasons for eliminating the other option. It covers CLF, SAA, DVA and CloudOps, and there's an async course that runs entirely over text. It's all conducted in Japanese, but if that works for you, take a look 🥺

<LinkCard url="https://menta.work/plan/21670?ref=mentor_profile" />
