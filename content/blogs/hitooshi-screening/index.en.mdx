...
description: "A user who actually passed Hitooshi's membership screening explains it all: the officially disclosed screening items, the truth behind the rumored 10% acceptance rate, the two-step screening flow with the actual LINE result notification, and practical tips to improve your chances."
...
The [Terms of Service](https://hito-oshi.com/rule/), Article 3, also lists the eligibility requirements: being single, having no current partner, age, location, and documents. For the details of each — including the full service-area list — see [my guide to Hitooshi's service areas and sign-up requirements](/en/blogs/zakki/hitooshi-eligibility).
...
If you also want to know up front whether you can leave should it not suit you, [how I withdrew from Hitooshi and what the cancellation fee came to](/en/blogs/zakki/hitooshi-withdrawal) walks through the exit. Knowing it before you apply takes some of the pressure off.

<br />

If you do decide to join, the Summer Matchmaking Support Campaign is on right now, and the invitation code saves you 26,700 yen (cannot be combined with other campaigns; the discount amount is the same whichever campaign applies). Feel free to use mine☺️

The cutoff is Sunday, August 30. Finish the registration and the first-interview booking within the period and you still qualify even if the screening or the interview lands in September — so getting the application in first is the way to go.
