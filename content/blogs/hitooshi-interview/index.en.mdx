...
description: "A real user explains Hitooshi's first interview: the roughly 45-minute Zoom session, what you are asked (the questions), the flow up to the day, how to prepare, and dress-code tips. Includes a referral-code campaign worth 26,700 yen in savings."
...
- Have a photo ID ready (driver's license or passport)
...
If the screening that comes with the interview is what worries you, check out [my article on the screening criteria and the real acceptance rate](/en/blogs/zakki/hitooshi-screening) as well!
...
If you do enroll after the interview, the Summer Matchmaking Support Campaign is on right now, and using the invitation code gets you **26,700 yen in savings** (as of August 2026). There's no reason not to use it, so if you'd like, please feel free to use my referral code☺️

By the way, the deadline is Sunday, August 30. Only the registration and the interview booking need to be done by then — the interview day itself can be in September. So once this article has given you the picture, locking in a slot first is the safest move.
